export const englishTextMap: Record<string, string> = {
  ...
  卷装: 'Roll-packed',
  张装: 'Sheet-packed',
  单张裁切: 'Single-sheet Cutting',
  '折叠 / 风琴折': 'Fan-fold',
  手工贴标: 'Manual Labeling',
  自动贴标: 'Automatic Labeling',
  半自动贴标: 'Semi-automatic Labeling',
  上出: 'Top Out',
  下出: 'Bottom Out',
  左出: 'Left Out',
  右出: 'Right Out',
  内卷: 'Inside Wound',
  外卷: 'Outside Wound',
  永久胶: 'Permanent Adhesive',
  强粘胶: 'High-tack Adhesive',
  冷冻胶: 'Freezer Adhesive',
  耐高温胶: 'High-temperature Adhesive',
  哑膜: 'Matte Film',
  亮膜: 'Gloss Film',
  哑油: 'Matte Varnish',
  光油: 'Gloss Varnish',
  防刮: 'Scratch-resistant',
  防水: 'Waterproof',
  白墨打底: 'White Ink Base',
  四色印刷: 'CMYK Printing',
  单黑: 'Black Only',
  专色: 'Spot Color',
  '四色 + 白墨': 'CMYK + White Ink',
  '可变数据 / 条码': 'Variable Data / Barcode',
  '专注标签印刷、包装印刷与企业定制印刷服务':
    'Focused on label printing, packaging printing, and custom business printing services',
  ...
  标签印刷机: 'Label Printer',
  不干胶卷标印刷机: 'Self-adhesive Roll Label Press',
  不干胶印刷机: 'Self-adhesive Label Press',
  全自动标签模切机: 'Automatic Label Die-cutting Machine',
  交付形式: 'Delivery Form',
  贴标方式: 'Labeling Method',
  '出标 / 卷标方向': 'Roll Direction',
  卷芯内径: 'Roll Core Diameter',
  每卷数量: 'Pieces per Roll',
  胶性: 'Adhesive',
  使用环境: 'Usage Environment',
  表面处理: 'Surface Finish',
  印刷颜色: 'Print Color',
  已有设计文件: 'Design File Ready',
  设计文件地址: 'Design File URL',
  需要设计协助: 'Need Design Support',
  需要样稿确认: 'Need Sample Approval',
  包装与发货: 'Packaging & Shipping',
  期望交期: 'Expected Delivery',
