...
const templateSpecs = [
  ['1', '1', '不干胶标签产品配置模板', [MATERIAL_COATED, MATERIAL_PET], [PROCESS_LAMINATION, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['2', '2', '卷标标签批量配置模板', [MATERIAL_COATED, MATERIAL_PP], [PROCESS_LAMINATION, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['3', '3', '食品饮料标签配置模板', [MATERIAL_COATED, MATERIAL_PET], [PROCESS_LAMINATION, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['4', '4', '日化美妆标签配置模板', [MATERIAL_PET, MATERIAL_PP], [PROCESS_LAMINATION, PROCESS_HOT_STAMP, PROCESS_UV, PROCESS_DIE_CUT]],
  ['5', '5', '医药保健标签配置模板', [MATERIAL_COATED], [PROCESS_LAMINATION, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['6', '6', '工业电子标签配置模板', [MATERIAL_SILVER, MATERIAL_PET], [PROCESS_LAMINATION, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['7', '7', '防伪标签配置模板', [MATERIAL_FRAGILE, MATERIAL_PET], [PROCESS_DIE_CUT, PROCESS_VARIABLE, PROCESS_PROOFING]],
  ['8', '8', '可变二维码标签配置模板', [MATERIAL_COATED, MATERIAL_PET], [PROCESS_VARIABLE, PROCESS_DIE_CUT, PROCESS_PROOFING]],
  ['9', '9', '产品说明书配置模板', [MATERIAL_COATED], [PROCESS_DIE_CUT]],
  ['10', '10', '包装盒宣传册配置模板', [MATERIAL_COATED], [PROCESS_LAMINATION, PROCESS_HOT_STAMP, PROCESS_UV]],
];
